...
/** Trait for formatting ConfigError instances into human-readable strings.
  *
  * Implementations can provide different formatting strategies such as plain
  * text, tables, or JSON. See [[jurate.printers.DefaultPrinter]] and
  * [[jurate.printers.TablePrinter]].
  */
trait ErrorPrinter {
