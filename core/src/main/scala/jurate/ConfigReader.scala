...
/** Abstraction for reading configuration from environment variables and system
  * properties.
  *
...
/** A ConfigReader implementation backed by maps for testing.
  ...
  * @param props
  *   map of system property names to values
  */
case class MapConfigReader(
  ...
  /** Adds or updates an environment variable in the configuration.
    ...
    *   the value to set
    * @return
    *   a new MapConfigReader with the updated environment variable
    */
  ...
  /** Adds or updates a system property in the configuration.
    ...
    *   the value to set
    * @return
    *   a new MapConfigReader with the updated system property
    */
...
object ConfigReader {
  ...
  /** Creates an empty MapConfigReader for testing.
    *
    * @return
    *   a new MapConfigReader with no environment variables or system properties
    *   set
    */
